...
function Nevtrekh() {
  ...
  return (
    <div className="flex justify-center items-center bg-[url('/assets/bg-from-unsplash.jpg')] bg-cover bg-center bg-no-repeat w-screen h-screen dark:bg-gray-800 relative">
      ...
      <div className="w-full sm:w-[640px] md:w-[768px] lg:w-[1024px] h-fit rounded-3xl bg-blue-800 lg:flex hidden justify-center items-center relative z-10">
      ...
      <div
        className="flex flex-col w-full max-w-md px-6 py-8 mx-4 my-auto shadow-lg lg:hidden sm:px-8 rounded-2xl sm:mx-8 mobile-login-card relative z-20"
        style={{
      ...
      >
        ...
        >
          ...
          <Form.Item name="nuutsUg" className="mb-6">
            <Password placeholder="Нууц үг" className="h-12 text-base" />
          </Form.Item>
        </Form>
        <div className="flex flex-col gap-4 mt-4">
          ...
          <Button
            ...
            className="w-full h-12 text-base font-medium text-white bg-blue-800 border border-transparent rounded-lg hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Нэвтрэх
          </Button>
        </div>
      ...
      <div className="absolute left-0 right-0 flex flex-col items-center gap-2 px-4 bottom-2 sm:flex-row sm:justify-between">
        <div className="px-4 py-2 select-none rounded-xl"></div>
